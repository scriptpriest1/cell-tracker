      ...
      <div class="cell-table-section">
        ...
        <div class="search-bar m-0 mb-2 p-0 position-relative">
          ...
          <span class="search-icon position-absolute" style="top: 50%; right: 0; transform: translateY(-50%); padding: 0; padding-right: 12px">
            <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="http://www.w3.org/2000/svg" width="20px" ><path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"/></svg>
          </span>
    ...
    <div id="cell-members-page" class="data-container d-none">
      ...
      <div class="cell-table-section">
        ...
        <div class="search-bar m-0 mb-2 p-0 position-relative">
          <input type="text" class="search-input form-control w-100 pe-5" placeholder="Search" style="border-radius: 10px; width: 100%;">
          <span class="search-icon position-absolute" style="top: 50%; right: 0; transform: translateY(-50%); padding: 0; padding-right: 12px">
            <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="http://www.w3.org/2000/svg" width="20px" fill="#000" ><path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"/></svg>
          </span>
          <span class="loader d-none"></span>
        </div>
    ...
    <div id="reports-page" class="data-container d-none position-relative">
      ...
      <section class="reports-section">
        ...
        <div class="reports-body">
          ...
          <button type="button" class="bg-dark text-white position-absolute top-0 end-0">Create draft</button> <!-- Will be removed later when auto-generation is integrated -->
          ...
          <div class="reports-block mt-4">
            ...
            <div class="reports-container mt-2" data-date="01-08-2025">

              <div class="report-draft px-3 py-2 d-flex align-items-center justify-content-between gap-2" data-report-type="meeting" data-week="2" data-report-status="pending">
                <div class="text-bar d-flex align-items-center gap-2">
                  <h6 class="m-0 p-0 week">Week 2:</h6>
                  <p class="m-0 p-0 description">Enter a paragraph here</p>
                </div>

                <div class="action-bar d-flex align-items-center justify-content-between gap-2">
                  <span class="label"></span>
                  <button class="publish-btn m-0 p-0" data-cell-id="">Publish</button>
                </div>
              </div>
